...
通过MESI协议，flush、refresh操作配合。



#### 2.6 哪些情况会引起指令重排序，使得出现有序性问题？
...
#### 10.5 Synchronized和lock有什么区别？用新的lock有什么好处？
